...
SECRET_KEY = 'django-insecure-8y*^lwbrhw2$+&-v7-*jvx=$pba7&foo8boo-50(n&ihai*0d6'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'postgres',
        'USER': 'TheArchitect',
        'PASSWORD': 'Valamogulez001',
        'HOST': 'student-managment-db.cgny8ywcoss3.us-east-1.rds.amazonaws.com',
        'PORT': '5432',
